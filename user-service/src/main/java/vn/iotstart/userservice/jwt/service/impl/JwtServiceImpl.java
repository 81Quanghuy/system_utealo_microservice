package vn.iotstart.userservice.jwt.service.impl;
...
import vn.iotstart.userservice.jwt.service.JwtService;
...
public class JwtServiceImpl implements JwtService {
	...
	public String generateAccessToken(final Account account) {
		...
		return this.jwtUtil.generateAccessToken(account);
	}

	@Override
	public String generateRefreshToken(Account account) {
		log.info("JwtServiceImpl, String, generateRefreshToken");
		return this.jwtUtil.generateRefreshToken(account);
	}
