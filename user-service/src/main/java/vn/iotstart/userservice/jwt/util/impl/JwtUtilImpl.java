package vn.iotstart.userservice.jwt.util.impl;
...
import vn.iotstart.userservice.constant.AppConstant;
import vn.iotstart.userservice.entity.Account;
import vn.iotstart.userservice.jwt.util.JwtUtil;
...
public class JwtUtilImpl implements JwtUtil {
	...
	public String generateAccessToken(final Account account) {
		...
		claims.put("role", account.getUser().getRole().name());
		return this.createAccessToken(claims, account.getUser().getId());
	}

	@Override
	public String generateRefreshToken(Account account) {
		final Map<String, Object> claims = new HashMap<>();
		return this.createRefreshToken(claims, account.getUser().getId());
	}
